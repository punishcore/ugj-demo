...
export default function Testimonial() {
  ...
  return (
    <section ref={sectionRef} id="testimoni" className="px-4 sm:px-8 md:px-16 lg:px-32 py-12 sm:py-16 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800">
